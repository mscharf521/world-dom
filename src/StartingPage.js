  ...
  return <div className="StartPage">
    <div className="StartPage-background">
      ...
      <div className="HomeInfoPage">
        ...
        <p className="HowToPlayText" ref={infoRef}>The world is in the midst of a nuclear apocalypse. You lead one of the surviving nations which have been forced into 
        ...
        <ol className="WaysToPlayList">
            ...
            <li>Add population or location restrictions to the capital cities which can be chosen.</li>
          </ol>
      </div>
    </div>
  </div>
